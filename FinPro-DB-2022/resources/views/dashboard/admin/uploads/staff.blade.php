...
<body class="bg-gray-900">
    ...
    <div class="container mt-8 mx-auto text-white mb-12">
        ...
        <div class="flex justify-center my-8">
            <form action="{{ route('admin.uploadstaff') }}" class="w-1/2 bg-gray-800 rounded-md p-8 space-y-8 text-md" method="post">
                @csrf
                ...
                <div class="space-y-4 text-lg">
                    ...
                    <input type="password" name="password_confirmation" placeholder="Input New Staff's Confirm Password Here" class="w-full h-12 p-4 rounded-md text-black" value="{{ old('password_confirmation') }}">
                ...
                <div class="space-y-4 text-lg">
                    ...
                    <input type="text" name="pnumber" placeholder="Input New Staff's Phone Number Here" class="w-full h-12 p-4 rounded-md text-black" value="{{ old('pnumber') }}">
