                ...
                <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                    ...
                    <div class="hidden sm:block sm:ml-6">
                        <div class="flex space-x-4">
                            ...
                            <a href="{{ route('staff.delivery') }}" class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium" aria-current="page">Delivery</a>
                        </div>
                    </div>
                </div>
        ...
        <table class="table-auto text-white border border-black border-collapse mt-8 w-full">
            ...
            <tbody class="bg-gray-600 text-center">
                ...
                <tr class="row border border-black font-medium text-lg">
                    <td>DR {{ $deliveries->transactionID }}</td>
                    <td>{{ $deliveries->nama }}</td>
                    <td>
                        <ul>
                    ...
                    <td>Rp {{ $deliveries->totalHarga }}</td>
                    <td>{{ $deliveries->status}}</td>
                    <td>BCA</td>
                    <td><a class="bg-green-600 text-white p-1 rounded-md hover:bg-green-400 hover:scale-105 transition-all" href="{{ route('staff.deliveryApprove',$deliveries->transactionsID) }}">Approve</a></td>
                </tr>
                @endforeach
            </tbody>
        </table>
