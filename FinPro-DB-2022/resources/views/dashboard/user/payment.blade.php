    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-8 order-md-1 mb-4">
            <h4 class="d-flex justify-content-between align-items-center mb-3">
              <span class="text-muted">Manual Transfer</span>
              <span class="badge badge-secondary badge-pill">3</span>
            </h4>
            <ul class="list-group mb-3">
              <li class="list-group-item d-flex justify-content-between lh-condensed">
              ...
              <li class="list-group-item d-flex justify-content-between lh-condensed">
                <form action="{{ route('user.checkPayment') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div>
                        ...
                        <input type="file" class="form-control" aria-label="file example" name="buktiPembayaran" required="required">
                        <div class="invalid-feedback">Example invalid form file feedback</div>
                        <span class="error">@error('buktiPembayaran'){{ $message }} @enderror</span>
                    </div><br>
                    <div>
                ...
                <!-- <button class="btn btn-lg btn-block mb-5" type="submit"> <a href="payment.html">Submit payment</a> </button> -->
              </div>
                                    <!-- Modal -->
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn" data-bs-dismiss="modal">Not yet</button>
                    <button type="submit" class="btn btn" value="submit">Yes I have</button>
                  </div>
                </div>
              </div>
            </div>
